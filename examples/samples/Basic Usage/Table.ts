...
const employeesData = JSON.stringify([
  ...
  ["Diana Ross", "Sales", "Account Executive", 2021, 65000],
  ["Eve Wilson", "Engineering", "Junior Developer", 2023, 58000],
  ["Frank Miller", "Marketing", "Content Writer", 2020, 52000],
  ["Grace Lee", "Sales", "Sales Director", 2017, 105000],
  ["Henry Davis", "Engineering", "DevOps Engineer", 2019, 88000],
  ["Iris Chen", "Marketing", "Brand Manager", 2018, 82000],
  ["Jack Taylor", "Sales", "Business Analyst", 2022, 62000],
  ["Karen White", "Engineering", "QA Lead", 2017, 95000],
  ["Leo Martinez", "Sales", "Account Manager", 2020, 71000],
  ["Mia Thompson", "Engineering", "Frontend Developer", 2021, 75000],
  ["Noah Garcia", "Marketing", "SEO Specialist", 2022, 55000],
  ["Olivia Anderson", "Sales", "Regional Manager", 2016, 110000],
  ["Paul Robinson", "Engineering", "Backend Developer", 2020, 85000],
