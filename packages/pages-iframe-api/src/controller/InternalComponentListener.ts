...
export interface InternalComponentDispatcher {
  /*
   * The component controller responsible to be the component's entry point to interact with CaseHub Pages
   */
  componentController: PagesComponentController | undefined;
  ...
  /*
   * Sends a message to CaseHub Pages
   */
