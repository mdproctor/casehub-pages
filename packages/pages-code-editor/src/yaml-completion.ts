...
const CONTEXT_KEYS: Record<string, Entry[]> = {
  ...
  'properties': [
    { label: 'title', detail: 'display title' },
    ...
    { label: 'visible', detail: 'visibility (true/false)' },
    { label: 'lookup', detail: 'data lookup config' },
    { label: 'chart', detail: 'chart display options' },
    { label: 'subtype', detail: 'component subtype' },
    { label: 'filter', detail: 'filter settings' },
    { label: 'refresh', detail: 'auto-refresh config' },
    { label: 'columns', detail: 'column configuration' },
    { label: 'csvExport', detail: 'enable CSV export' },
    ...
    { label: 'extraConfiguration', detail: 'raw ECharts JSON merge' },
  ],
  'chart': [
    { label: 'title', detail: 'chart title text' },
    { label: 'margin', detail: 'chart margins (top/right/bottom/left)' },
    { label: 'zoom', detail: 'enable data zoom (true/false)' },
    { label: 'legend', detail: 'legend config (show, position)' },
    { label: 'axis', detail: 'axis config (x, y titles and labels)' },
    { label: 'grid', detail: 'grid lines (x, y)' },
    { label: 'resizable', detail: 'resizable chart (true/false)' },
    { label: 'height', detail: 'chart height' },
    { label: 'width', detail: 'chart width' },
  ],
  'margin': [
  ...
  'legend': [
    { label: 'show', detail: 'show legend (true/false)' },
    { label: 'position', detail: 'top | bottom | left | right' },
  ],
  'axis': [
    { label: 'x', detail: 'x-axis config' },
    { label: 'y', detail: 'y-axis config' },
  ],
  'x': [
    { label: 'title', detail: 'x-axis title' },
    { label: 'labels_show', detail: 'show axis labels' },
    { label: 'labels_angle', detail: 'label rotation angle' },
  ],
  'y': [
    { label: 'title', detail: 'y-axis title' },
    { label: 'labels_show', detail: 'show axis labels' },
    { label: 'labels_angle', detail: 'label rotation angle' },
  ],
  'grid': [
    { label: 'x', detail: 'show x grid lines' },
    { label: 'y', detail: 'show y grid lines' },
  ],
  'lookup': [
    ...
    { label: 'rowCount', detail: 'limit result rows' },
  ],
  'group': [
    { label: 'columnGroup', detail: 'grouping column config' },
    { label: 'functions', detail: 'result columns / aggregations' },
  ],
  'columnGroup': [
    { label: 'source', detail: 'source column name' },
    { label: 'id', detail: 'output column id' },
    { label: 'strategy', detail: 'distinct | fixedCalendar | dynamicRange | dynamic' },
    { label: 'unit', detail: 'calendar unit (QUARTER, MONTH, DAY_OF_WEEK, ...)' },
    { label: 'maxIntervals', detail: 'max intervals (default 15)' },
    { label: 'emptyIntervals', detail: 'include empty intervals' },
    { label: 'ascendingOrder', detail: 'ascending order (default true)' },
  ],
  'functions': [
    { label: 'source', detail: 'source column name' },
    { label: 'id', detail: 'output column id' },
    { label: 'function', detail: 'COUNT | SUM | AVERAGE | MIN | MAX | DISTINCT' },
  ],
  'filter': [
    { label: 'column', detail: 'column to filter on' },
    { label: 'function', detail: 'IS_NULL | EQUALS_TO | LIKE_TO | BETWEEN | IN | ...' },
    { label: 'args', detail: 'filter arguments' },
    { label: 'enabled', detail: 'enable filtering (true/false)' },
    { label: 'notification', detail: 'show filter notification' },
    { label: 'listening', detail: 'listen for filter events' },
    { label: 'selfApply', detail: 'apply own filter' },
    { label: 'drillDown', detail: 'enable drill-down' },
  ],
  'sort': [
    { label: 'column', detail: 'column to sort by' },
    { label: 'order', detail: 'ASCENDING | DESCENDING' },
  ],
  'refresh': [
    { label: 'interval', detail: 'refresh interval (seconds)' },
    { label: 'showStaleIndicator', detail: 'show stale data indicator' },
  ],
  'datasets': [
    { label: 'uuid', detail: 'dataset identifier' },
